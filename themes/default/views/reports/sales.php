<?php
    ...
    if ($this->input->post('product_note')) {
        $v .= "&product_note=" . $this->input->post('product_note');
    }
            ...
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang("product_note","product_note"); ?>
                                <?php echo form_input('product_note', (isset($_POST['product_note']) ? $_POST['product_note'] : ""), 'class="form-control tip" id="product_note"'); ?>
                            </div>
                        </div>
